...
Usage:
  npx @changemakerstudios/youtrack-mcp [options] [-- server-args]
  @changemakerstudios/youtrack-mcp [options] [-- server-args]
...
Examples:
  ...
  npx @changemakerstudios/youtrack-mcp

  # Run with HTTP transport
  npx @changemakerstudios/youtrack-mcp --http --port 8000

  # Pass arguments to the Python server
  npx @changemakerstudios/youtrack-mcp -- --log-level DEBUG

  # Set environment variables inline
  YOUTRACK_URL=https://your.youtrack.cloud YOUTRACK_API_TOKEN=your-token npx @changemakerstudios/youtrack-mcp
...
Add this to your Claude Desktop config:
{
  "mcpServers": {
    "youtrack": {
      "command": "npx",
      "args": ["@changemakerstudios/youtrack-mcp"],
      "env": {
